...
def run_eval(
    ...
    return {
        ...
        "config": {
            ...
            "k": k,
            "fetch_k": fetch_k,
            "reranker_enabled": retriever.settings.reranker_enabled,
            "reranker_model": retriever.settings.reranker_model if retriever.settings.reranker_enabled else None,
            "reranker_top_n": retriever.settings.reranker_top_n if retriever.settings.reranker_enabled else None,
        },
        "aggregate": aggregate,
