    ...
    documents = [
        {
            ...
            "processing_status": (
                "completed" if i % 3 == 0 else "processing" if i % 3 == 1 else "failed"
            ),
...
async def get_statistics(admin: dict = Depends(require_admin)):
    ...
    return {
        ...
        "by_type": {"PDF": 8500, "Word": 4200, "Text": 2100, "CSV": 620},
        "by_status": {"completed": 14850, "processing": 420, "failed": 150},
        "by_stage": {
            "indexed": 14850,
            "embedding": 320,
            "extraction": 100,
...
@router.get("/export")
async def export_data(format: str = "csv", admin: dict = Depends(require_admin)):
