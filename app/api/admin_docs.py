...
async def process_batch(
    request: ProcessBatchRequest, admin: dict = Depends(require_admin)
):
    """
...
async def get_batch_status(batch_id: str, admin: dict = Depends(require_admin)):
    """
...
async def process_all_documents(admin: dict = Depends(require_admin)):
    """
