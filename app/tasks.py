...
def process_document(self: Task, document_id: str, file_path: str, metadata: dict):
    ...
    try:
        ...
        self.update_state(
            state="PROGRESS",
            meta={"current": 10, "total": 100, "status": "Downloading document..."},
        )

        # Step 2: Extract text
        self.update_state(
            state="PROGRESS",
            meta={"current": 30, "total": 100, "status": "Extracting text..."},
        )
        ...
        self.update_state(
            state="PROGRESS",
            meta={"current": 80, "total": 100, "status": "Storing in database..."},
        )
        ...
        self.update_state(
            state="PROGRESS",
            meta={"current": 95, "total": 100, "status": "Updating search index..."},
        )
