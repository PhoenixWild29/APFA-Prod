...
class UserRegistrationRequest(BaseModel):
    ...
    confirm_password: str = Field(
        ..., description="Password confirmation", min_length=8, max_length=128
    )
    ...
    marketing_consent: bool = Field(
        default=False, description="Marketing email consent"
    )
...
class RegistrationResponse(BaseModel):
    ...
    user_id: str = Field(
        ..., description="Newly created user ID", min_length=1, max_length=255
    )
    username: str = Field(
        ..., description="Registered username", min_length=3, max_length=50
    )
...
class RegistrationEvent(BaseModel):
    ...
    user_id: Optional[str] = Field(
        None, description="User ID (None for failed attempts)", max_length=255
    )
    email: EmailStr = Field(..., description="Email address from registration")
    ...
    user_agent: str = Field(
        ..., description="Browser/client user agent", max_length=500
    )
...
class WebSocketRegistrationMessage(BaseModel):
    ...
    event_data: RegistrationEvent = Field(..., description="Registration event details")
    admin_notification: bool = Field(
        default=False, description="Whether to notify administrators"
    )
