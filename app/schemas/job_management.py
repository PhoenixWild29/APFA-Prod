...
class PipelinePerformanceMetrics(BaseModel):
    ...
    batch_processing_throughput_docs_per_sec: float = Field(
        ..., description="Batch throughput"
    )
    ...
    system_resource_utilization: Dict[str, float] = Field(
...
class BottleneckAnalysis(BaseModel):
    ...
    current_utilization: Dict[str, float] = Field(
